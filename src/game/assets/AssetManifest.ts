...
export const dataAssets: DataAssetDescriptor[] = [
  ...
  { key: LegacyDataKeys.ATTACKS, url: `${DATA_BASE_PATH}/legacy/attacks.json` },
  { key: LegacyDataKeys.ANIMATIONS, url: `${DATA_BASE_PATH}/legacy/animations.json` },
  { key: LegacyDataKeys.ITEMS, url: `${DATA_BASE_PATH}/legacy/items.json` },
  { key: LegacyDataKeys.MONSTERS, url: `${DATA_BASE_PATH}/legacy/monsters.json` },
  { key: LegacyDataKeys.ENCOUNTERS, url: `${DATA_BASE_PATH}/legacy/encounters.json` },
  { key: LegacyDataKeys.NPCS, url: `${DATA_BASE_PATH}/legacy/npcs.json` },
  { key: LegacyDataKeys.EVENTS, url: `${DATA_BASE_PATH}/legacy/events.json` },
  { key: LegacyDataKeys.SIGNS, url: `${DATA_BASE_PATH}/legacy/signs.json` },
